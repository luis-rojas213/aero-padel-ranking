...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post rankings_url, params: { ranking: { player_id: @player.id, points: @ranking.points } }
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { player_id: @player.id, points: @ranking.points } }
